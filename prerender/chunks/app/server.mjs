...
import { $fetch } from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/ofetch/dist/node.mjs'
import { createHooks } from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/hookable/dist/index.mjs'
import {
  getContext,
  executeAsync
} from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/unctx/dist/index.mjs'
import {
  createMemoryHistory,
  createRouter,
  START_LOCATION,
  ...
  RouterView
} from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/vue-router/dist/vue-router.node.mjs'
import {
...
import { renderSSRHead } from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/@unhead/ssr/dist/index.mjs'
import {
  getActiveHead,
  createServerHead as createServerHead$1
} from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/unhead/dist/index.mjs'
import { defineHeadPlugin } from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/@unhead/shared/dist/index.mjs'
import {
  ssrRenderSuspense,
  ssrRenderComponent,
  ssrRenderVNode,
...
import { defu } from 'file:///Users/markeltskhadadze/Desktop/vue-test/vue-todo/node_modules/defu/dist/defu.mjs'
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-44be4928.mjs').then((m) => m.default || m)
  },
  {
    name: 'tariffs',
    path: '/tariffs',
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/tariffs-55f6f4da.mjs').then((m) => m.default || m)
  }
]
const appHead = {
  meta: [
...
const layouts = {
  default: () => import('./_nuxt/default-c630bde5.mjs').then((m) => m.default || m)
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() =>
      import('./_nuxt/error-404-48b29597.mjs').then((r) => r.default || r)
    )
    const _Error = /* @__PURE__ */ defineAsyncComponent(() =>
      import('./_nuxt/error-500-863d5ed5.mjs').then((r) => r.default || r)
    )
...
const _sfc_main = {
  ...
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() =>
      import('./_nuxt/island-renderer-f4d56669.mjs').then((r) => r.default || r)
    )
    const nuxtApp = useNuxtApp()
